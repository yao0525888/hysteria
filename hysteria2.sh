...
[Service]
Type=oneshot
ExecStart=/bin/bash -c "systemctl start hysteria"
RemainAfterExit=yes
[Install]
...
EOF
    ...
    if [[ -n $(systemctl status hysteria 2>/dev/null | grep -w active) ]]; then
        green "======================================================================================"
...
uninstall_hy2() {
    ...
    rm -f /lib/systemd/system/hysteria.service /lib/systemd/system/hysteria@.service
